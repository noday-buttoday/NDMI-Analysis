...
namespace IMG_Converter
{
    ...
    public class ImgData
    {
        ...
        /// <summary>이미지 위도 경도</summary>
        public LatLon latlon { get; set; }
        /// <summary>이미지 값</summary>
    ...
    /// @version :    1.0
    /// @revision : 
    public class ImgUtmData
    {
        public ImgUtmData()
        {}

        public ImgUtmData(double x, double y, double value)
        {
            this.x = x;
            this.y = y;
            this.value = value;
    ...
    /// @class :     LatLon
    /// @brief :     위도 경도
    /// @author :    JuKyoung Kim (jkim@soletop.com)
    /// @date :      2016-10-21
    /// @version :    1.0
    /// @revision : 
    public class LatLon
